...
/**
 * a JavaFX controller for the level menu
...
public class LevelMenuController {
	...
	/**
	 * display the levels available to the player
	 */
	...
	/**
	 * set the attached main menu screen
	 * @param mainScreen
	 */
	...
	/**
	 * scroll back to the previous page of levels
	 */
	@FXML
	...
	/**
	 * scroll forward to the next page of levels
	 */
	@FXML
	...
	/**
	 * open the first dungeon on the page
	 */
	@FXML
	...
	/**
	 * open the second dungeon on the page
	 */
	@FXML
	...
	/**
	 * open the third dungeon on the page
	 */
	@FXML
	...
	/**
	 * open the fourth dungeon on the page
	 */
	@FXML
